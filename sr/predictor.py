...
class Predictor:
    def __init__(self, config):
        ...
        if model_type == 'without_pke':
        ...
        elif model_type == 'vessel_masked_decoupled_multiscale':
        ...
        elif model_type == 'vessel_masked_spatial_gated_multiscale':
        ...
        elif model_type == 'vessel_masked_zero_start_residual_multiscale':
            ...
            print(
                '✅ Loaded G9 agreement-gated multi-scale descriptor model'
            )
        else:
